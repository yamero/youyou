<?php
class BuyReleaseBycardController extends ControllerBase{
    public function indexAction($pageNum){
        ...
        $phql="select br.id,br.card_num,br.point_num,br.buy_time,u.account from BuyReleaseBycard as br join User as u";
        $buyreleasebycard=$this->modelsManager->executeQuery($phql);
        $paginator = new \Phalcon\Paginator\Adapter\Model(
            array(
                "data" => $buyreleasebycard,
        ...
        $this->view->setVars(array(
            ...
            'page'=>$page,
            'operation'=>'buyreleasebycardlist'
        ));
    }
